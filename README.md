...
| BizTalk | Azure Logic Apps | XLANG orchestration → workflow.json | [`xlang-to-logic-apps.md`](patterns/biztalk/xlang-to-logic-apps.md) |
...
- More source languages and targets (RPG, PL/I; Java and .NET targets).
